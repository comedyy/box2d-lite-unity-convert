...
public class NewBehaviourScript : MonoBehaviour {
    void Start ()
    {
        Body bodyA = new Body() { position = new Vector2(0, 0), rotation = Mathf.PI / 6, width = new Vector2(2, 2) };
        Body bodyB = new Body() { position = new Vector2(2.8f, 0), rotation = 0, width = new Vector2(2f, 4f) };
